...
class ListarNotaFiscalTest {
    @Test void aplicaPaginacaoBaseUmEFiltrosNoBanco() {
        ...
        when(repository.findWithFilters(anyLong(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(Pageable.class)))
        ...
        FilterNotaFiscalDTO filtro = FilterNotaFiscalDTO.builder().empresaId(3L).page(2).limit(50)
                ...
                .chaveAcesso("3526 0999 9999 9900 0199 5500 1000 0000 0110 0000 0010")
        ...
        verify(repository).findWithFilters(eq(3L), isNull(), isNull(), eq(DocumentoFiscalAmbiente.HOMOLOGACAO), isNull(),
                eq("35260999999999000199550010000000011000000010"), eq(9L), eq("1"),
    ...
    @Test void rejeitaLimiteEDatasInvalidas() {
        ...
        assertThatThrownBy(() -> service.listar(FilterNotaFiscalDTO.builder().empresaId(3L).chaveAcesso("123").build()))
                .isInstanceOf(ApiException.class).hasMessageContaining("44 dígitos");
    }
}
